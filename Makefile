...
check: profile-clean ## run tests using the library test runner
	./venv scheme -b ./local/lib/csv9.5.3/a6le/scheme.boot --program src/arew.scm check src/check-check.scm
	./venv scheme -b ./local/lib/csv9.5.3/a6le/scheme.boot --program src/arew.scm check src/
